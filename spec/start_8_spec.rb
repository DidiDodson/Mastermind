...
describe Start_8 do
    describe "#initialize" do
        ...
        it "contains a secret" do
            ...
            expect(start.randomize.length).to eq(8)
        end
    end
    ...
    describe "#start_message" do
      it "prints the welcome message" do
        ...
        expect(start.start_message).to eq "I have generated an advanced sequence with eight elements made up of: (r)ed, (g)reen, (b)lue, (y)ellow, (o)range, and (m)agenta. \nUse (q)uit at any time to end the game. \nWhat's your guess?"
      end
    end
